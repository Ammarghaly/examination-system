...
const cardsGrid = document.querySelector("cards-gri");

const exam = ` <div class="exam-card">
        <div class="card-header">
          <span class="subject-tag">LITERATURE</span>
        </div>

        <div class="card-body">
          <h3 class="exam-title">Poetry Analysis Quiz</h3>
        ...
        <div class="card-footer">
          ...
          <div class="teacher-info">
            ...
            />
            <span class="teacher-name">Mr. Vance</span>
          </div>
        </div>
      </div>`;
